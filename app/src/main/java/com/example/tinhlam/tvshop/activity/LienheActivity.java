...
public class LienheActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng Daihoccantho = new LatLng(10.031034, 105.768808);
        mMap.addMarker(new MarkerOptions().position(Daihoccantho).title("Truong dai hoc Can Tho").snippet("3/2, Xuân Khánh, Ninh Kiều, TP Cần Thơ").icon(BitmapDescriptorFactory.defaultMarker()));
        mMap.setMapType(GoogleMap.MAP_TYPE_NORMAL);
        CameraPosition cameraPosition = new CameraPosition.Builder().target(Daihoccantho).zoom(90).build();
